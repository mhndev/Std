...
class OpenOptions implements Interfaces\iPoirotOptions
{
     ...
     * Set Options
     *
     * @param array|Interfaces\iPoirotOptions $options
     *
     * @return $this
     */
    function from($options)
    {
        ...
        elseif ($options instanceof Interfaces\iPoirotOptions)
     ...
     *
     * @param Interfaces\iPoirotOptions $options Options Object
     *
     * @throws \Exception
     * @return $this
     */
    function fromOption(Interfaces\iPoirotOptions $options)
    {
